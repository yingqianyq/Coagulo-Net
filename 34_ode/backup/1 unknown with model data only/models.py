...
class PINN(tf.keras.Model):
    ...
    def train_op(self, t_f, f, t_u, u, eps):
        with tf.GradientTape() as tape:
            ...
            # loss_f = tf.reduce_mean((f_pred - f)**2)
            loss_f = 1e-10 * tf.reduce_mean(eq10 ** 2) + \
        ...
        return loss, loss_u, loss_f, eq10_loss, eq31_loss, eq32_loss
    ...
    def train(self, t_f, f, t_u, u, eps, niter=10000):
        ...
        for it in range(niter):
            total_loss, data_loss, ode_loss, eq10_loss, eq31_loss, eq32_loss = train_op(t_f, f, t_u, u, eps)
